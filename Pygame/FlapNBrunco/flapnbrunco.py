...
pygame.display.set_caption("FlapNBrunco")

# Frame por segundo
clock = pygame.time.Clock()

# Carrega imagens e efeitos sonoros
img_player = pygame.image.load('img/player.gif')
...
img_bg1 = pygame.image.load('img/bg_stars.png')
img_bg2 = pygame.image.load('img/bg_stars.png')
img_start = pygame.image.load('img/gamestart.png')
jump = pygame.mixer.Sound('sounds/jump.wav')
hit = pygame.mixer.Sound('sounds/explode.wav')
jump.set_volume(0.1)
hit.set_volume(0.1)

# Funcoes para desenhar objetos na tela
...
# Funcao para exibir a introducao
def intro():
...
close = False
# Jogador
playerx = 350 # Posicao inicial
playery = 250
# Velocidade inicial do jogador
speed = 5
# Obstaculo
wall_locx = 700 #localizacao
...
while not close:
    ...
    # Desenha jogador
    player(player_area)
    # Incrementa a posicao y do jogador
    playery += speed
    ...
    wall()
    # Decrementa a posicao x do obstaculo
    wall_locx -= speedwall
